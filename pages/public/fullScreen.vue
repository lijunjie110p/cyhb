...
<template>
	<view class="main">
		<view class="line u-flex u-flex-col u-col-center u-row-center" >
			<view class="u-font-28 u-text-center u-margin-bottom-20">更新中...</view>
			<u-line-progress active-color="#0077FF" :striped="true" :striped-active="true" height="35" :percent="percent"></u-line-progress>
		</view>
