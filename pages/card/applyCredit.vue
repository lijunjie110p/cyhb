<template>
	<view class="main">
		<view class="form">
			<u-form :error-type="['toast']" :model="forminfo" ref="uForm">
				<u-form-item label-width="0" label=" " :border-bottom="false" prop="card_pic">
					<view class="u-flex-1">
						<view  class="text u-text-center"><text>请上传信用卡正面照片</text></view>
						<view class="slot-btn" @click="chooseImg">
							<u-image @click="chooseImg" v-if="forminfo.card_pic==''" width="100%"  mode="widthFix" src="/static/image/addcard_bg.png"></u-image>
							<u-image @click="chooseImg" v-if="forminfo.card_pic!=''"  width="100%" height="100%" mode="aspectFill" :src="bankimg"></u-image>
						</view>
					</view> 
				</u-form-item>
				<u-gap height="20" bg-color="#F2F2F2"></u-gap>
				<view class="padding-width-base">
					...
					<u-form-item label-width="150" label="有效日期" prop="valid_date">
						...
						<u-picker confirm-color="#0077FF" :params="timeparms" :safe-area-inset-bottom="true" @confirm="selectedDate" mode='time'
					...
					<u-form-item label-width="150" label="CVV2" prop="cvv2">
						...
						<u-icon slot="right" color="#FF763A" size="45" @click="showCvv2=true" name="question-circle"></u-icon>
					</u-form-item>
		...
		<view class="tips">
			<view class="u-font-24 u-content-color"><text>信用卡上传必须保证照片清晰、必须是本人的信用卡、要仔细核对卡号是否一致</text></view>
		</view>
		<view class="subbtn">
			<u-button @click="addCard" :hair-line="false" shape="circle" :custom-style="btnStyle">添加</u-button>
		</view>
