<template>
	<view class="main">
		<view class="u-rela">
			<u-swiper name="eimgurl" height="340" border-radius="0" :list="data.img_list"></u-swiper>
			<view class="grid">
		...
		<view class="u-margin-30">
			<u-image @click="share" src="/static/image/business/middle_bannel.png" width="100%" mode="widthFix"></u-image>
		</view>
		<view class="u-font-36 font-blod padding-width-base"><text>办卡分润</text></view>
		<view class="u-flex u-row-between u-col-center order ">
			<view class="u-text-center u-flex-1">
				...
				<view><text class="u-font-28 u-content-color">累计订单</text></view>
			</view>
			<view class="u-text-center u-flex-1">
				<view><text class="order-number">{{data.check_order}}</text></view>
				<view><text class="u-font-28 u-content-color">核计卡数</text></view>
			</view>
			<view class="u-text-center u-flex-1">
				<view><text class="order-number">{{data.check_order}}</text></view>
				<view><text class="u-font-28 u-content-color">办卡分润</text></view>
			</view>
		</view>
		...
		<view class="u-padding-30 u-margin-top-20">
			<view class="u-font-36 font-blod"><text>今日推荐</text></view>
			<view class="ks">
		...
		<view class="u-padding-30">
			<view class="u-font-36 font-blod"><text>热门卡片</text></view>
			<view @click="toWebView(item.lid)" class="hot-item u-flex u-col-center u-row-between"
