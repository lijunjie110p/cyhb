<template>
	<view class="main">
		<view class="head">
			<view class="banner">
				<view><text class="u-font-28">本月收入（元）</text></view>
			...
			<view class="content">
				<view class="u-padding-30 u-flex u-row-between">
					...
					<u-icon @click="initData" name="search" color="#0077FF" size="40"></u-icon>
				</view>
				<u-calendar toolTip="请选择开始日期和结束日期" btn-type="warning" range-bg-color="rgba(255,200,0,0.13)" range-color="#caedff"
				 active-bg-color="#0077FF" :safe-area-inset-bottom="true" v-model="showDate" max-date="2050-01-01" mode="range"
