	...
	<view class="main">
		...
		<u-cell-group :border="false">
			<u-cell-item :titleStyle="{fontSize:'30rpx'}" title="安全设置" :arrow="false">
				<u-switch slot="right-icon" active-color="#0078FF" v-model="checkedSec" :loading="checkLoading" @change="changeSecurity"></u-switch>
			</u-cell-item>
			<u-cell-item  :titleStyle="{fontSize:'30rpx'}" title="消息通知" :arrow="false">
				<u-switch slot="right-icon" active-color="#0078FF" v-model="checked" @change="change"></u-switch>
			</u-cell-item>
			<u-cell-item @click="jump('../public/addAccount?type=changeMobile')" :titleStyle="{fontSize:'30rpx'}" title="修改手机"></u-cell-item>
			<!-- <u-cell-item @click="chooseImage"  :titleStyle="{fontSize:'30rpx'}"
		...
		<view class="footbtn " v-if="hasLogin" @click="showModel=true"><text >退出登录</text></view>
		<u-modal confirm-color="#0078FF" :show-cancel-button="true" v-model="showModel" @confirm="outlogin" content="是否退出登录"></u-modal>
		<u-modal v-model="showFaceModel" :show-cancel-button="true" @cancel="checkLoading=false" @confirm="inter(1)">
